    ...
    <div class="wrapper" id="app">
        ...
        <header class="main-header">
            ...
            <a href="{{ url(config('adminlte.dashboard_url', '/')) }}" class="logo">
                ...
                <span class="logo-lg">{!! config('adminlte.logo', 'Casa do <b>Saber</b>') !!}</span>
            </a>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                @can('isSuperAdmin')
                    <sidebarsuperadmin-component></sidebarsuperadmin-component>
                @endcan
                ...
                @can('isFinanceiro')
                <sidebarfinanceiro-component></sidebarfinanceiro-component>
                @endcan

                @can('isProfessor')
                <sidebarprofessor-component></sidebarprofessor-component>
                @endcan

                @can('isPai')
                <sidebarpai-component></sidebarpai-component>
                @endcan
